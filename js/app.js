...
var CELULAR_EMPRESA = `5513991234567`;

var INSTAGRAM_EMPRESA = `seuInstagram`;
var FACEBOOK_EMPRESA = `seuFacebook`;
...
cardapio.metodos = {
    ...
    // aumnetar a quantidade do item no cardápio
    ...
    // altera os tgextos e exibe os botões das etapas
    carregarEtapa: (etapa) =>{
    ...
    carregarResumo: () =>{
        ...
        let complemento = MEU_ENDERECO.complemento ? ` / ${MEU_ENDERECO.complemento}` : '';

        $("#resumoEndereco").html(`${MEU_ENDERECO.endereco}, ${MEU_ENDERECO.numero}${complemento}, ${MEU_ENDERECO.bairro}`);
    ...
    // mostrar depoimentos
    mostrarDepoimento: (num) =>{

        // esconder todos
        $(".depoimento").addClass("hidden");

        // mostrar o selecionado
        $("#depoimento-" + num).removeClass("hidden");
        ...
        $("#btnDepoimento" + num).addClass("active");
    ...
    finalizarPedido: () =>{
        ...
        if (MEU_CARRINHO.length > 0 && MEU_ENDERECO != null){
            ...
            let complemento = MEU_ENDERECO.complemento 
                ? ` / ${MEU_ENDERECO.complemento}` 
                : '';

            texto += `\n${MEU_ENDERECO.endereco}, ${MEU_ENDERECO.numero}${complemento}, ${MEU_ENDERECO.bairro}`;
    ...
    carregarBotaoWhatsapp: () => {
        ...
        var texto = 'Olá! Gostaria de falar com o atendimento';
